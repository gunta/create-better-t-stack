...
| **Authentication**       | • Better-Auth (email/password, with more options coming soon)<br>• Clerk (managed authentication)<br>• Convex Auth (when using Convex backend)<br>• None                                                                                                    |
